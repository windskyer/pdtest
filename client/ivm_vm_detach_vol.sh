#!/usr/bin/ksh
#./ivm_vm_detach_vol.sh "172.30.126.12|padmin|24" 'lv:lvname1|pv:hdisk2|lu:sspcluster,ssppool,luudid'
#./ivm_vm_detach_vol.sh "172.30.126.12|padmin|24" 'lv:lvname1'
#./ivm_vm_detach_vol.sh "172.30.126.12|padmin|24" 'pv:hdisk2'
#./ivm_vm_detach_vol.sh "172.30.126.12|padmin|24" 'lu:sspcluster,ssppool,luudid'
...
out_log="${path_log}/out_ivm_vm_detach_vol_${DateNow}_${random}.log"
error_log="${path_log}/error_ivm_vm_detach_vol_${DateNow}_${random}.log"
