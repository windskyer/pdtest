...
if [ "$ivm_ip" == "" ]
then
	throwException "IP is null" "105035"
fi

if [ "$ivm_user" == "" ]
then
	throwException "User name is null" "105035"
fi

if [ "$lpar_id" == "" ]
then
	throwException "Lpar id is null" "105035"
fi
...
out_log="${path_log}/out_shutdown_vm_${DateNow}_${random}.log"
error_log="${path_log}/error_shutdown_vm_${DateNow}_${random}.log"
