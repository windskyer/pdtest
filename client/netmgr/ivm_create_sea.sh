...
create_sea () {
	...
	log_debug $LINENO "seainfo=${seainfo}"
...
create_sea_param () {
	...
	if [ "$ivm_ip" == "" -o "$ivm_user" == "" -o "$td" == "" -o "$vea" == "" -o "$dvea" == "" -o "$pvid" == "" ]
	then
...
out_log="${path_log}/out_ivm_create_sea_${DateNow}_${random}.log"
error_log="${path_log}/error_ivm_create_sea_${DateNow}_${random}.log"

log_debug $LINENO "$0 $*"


ivm_create_sea $1
#ivm_create_sea '172.30.126.12|padmin|ent1|ent5,ent6|ent5|1'
