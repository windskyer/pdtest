#!/usr/bin/ksh
# ./reconfig_lpar_extend_storage.sh "172.30.126.13|padmin|5|0.2|0.2|0.2|2|2|2|1024|1024|1024|128|" "aix1_lv1,2048|aix1_lv2,3072"
...
#       then
#           throwException "rec_stosize is null"
#       fi
#       
#       if [ "$lv_name[$lv_num]" == "" ]
#       then
#           throwException "lv name is null"
#       fi
...
out_log="${path_log}/out_reconfig_lpar_extend_storage_${DateNow}_${random}.log"
error_log="${path_log}/error_reconfig_lpar_extend_storage_${DateNow}_${random}.log"
