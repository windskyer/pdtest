...
if [ "$host_type" == "" ]
then
	throwException "host_type is null" "100000"
fi
...
out_log="${path_log}/out_pd_svc_reconfig_type_host_${DateNow}_${random}.log"
error_log="${path_log}/error_pd_svc_reconfig_type_host_${DateNow}_${random}.log"
...
#####                                                                           #####
#####################################################################################
svc_wwpn_info=$(ssh -i ${key_file} ${svc_user}@${svc_ip} "svctask chhost -type $host_type $host_id" 2> "${error_log}")
