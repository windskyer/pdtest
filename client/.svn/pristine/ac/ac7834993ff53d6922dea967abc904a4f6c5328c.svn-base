#!/usr/bin/ksh
# ./hmc_reconfig_vm_dlpar.sh "172.30.125.2|hscroot|p720-2|8|0.2|2|1024|128|"
# ./hmc_reconfig_vm_dlpar.sh "172.30.125.2|hscroot|p720-1|8|0.2|2|1024|128|"

# ./hmc_reconfig_vm_dlpar.sh "172.30.125.2|hscroot|p720-2|1|0.2|2|1024|128|" "lv00,4608"
# ./hmc_reconfig_vm_dlpar.sh "172.30.125.2|hscroot|p720-1|8|0.2|2|1024|128|" "lv06,10240"
...
reconfig_cpu_mem()
{
    ...
    then
    	if [ "$rec_uncap_weight" != "" ]
    	then
    		ssh_result=$(ssh ${hmc_user}@${hmc_ip} "chhwres -m $host_id -r proc -o s -a uncap_weight=${rec_uncap_weight} --id ${lpar_id}" 2>&1)
    		if [ "$(echo $?)" != "0" ]
    		then
    			throwException "$ssh_result" "105485"
    		fi
...
#      echo "lv_ppsize[$i]==${lv_ppsize[$i]}"
#      echo "lv_pps[$i]==${lv_pps[$i]}"
#      echo "rec_pps[$i]==${rec_pps[$i]}"
#    	echo "new_pps[$i]==${new_pps[$i]}"
