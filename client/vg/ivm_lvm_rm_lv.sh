...
out_log="${path_log}/out_ivm_lvm_rm_lv_${DateNow}_${random}.log"
error_log="${path_log}/error_ivm_lvm_rm_lv_${DateNow}_${random}.log"

log_debug $LINENO "$0 $*"

ivm_lvm_rm_lv $1 $2
#ivm_lvm_rm_lv '172.30.126.12|padmin|testvg' 'testlv'
